    ...
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-16 animate-fade-in">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 md:p-10 shadow-sm space-y-6 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          <p>
            2. This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <strong>www.daykart.in</strong> (&apos;Website&apos;), including the related mobile site and mobile application (hereinafter referred to as &apos;Platform&apos;).
          </p>
          ...
          <ul className="list-decimal pl-6 space-y-4 text-xs">
            ...
            <li>
              All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in <strong>Peddapuram</strong> and <strong>Andhra Pradesh</strong>.
            </li>
            <li>
