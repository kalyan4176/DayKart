...
function ProductsListContent() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-2 pb-6 sm:pt-4 sm:pb-8 md:py-10">
        <div className="flex items-center justify-between mb-3 sm:mb-6 md:mb-8 gap-4">
          <div>
            <h1 className="text-xl sm:text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white whitespace-nowrap">
