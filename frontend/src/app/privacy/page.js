    ...
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-16 animate-fade-in">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 md:p-10 shadow-sm space-y-6 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          <h2 className="text-base font-bold text-slate-900 dark:text-white mt-6">Data Deletion and Retention</h2>
          <p>
          ...
          <h2 className="text-base font-bold text-slate-900 dark:text-white mt-6">Your Rights</h2>
          <p>
            You may access, rectify, and update your personal data directly through the functionalities provided on the Platform.
          </p>

          <h2 className="text-base font-bold text-slate-900 dark:text-white mt-6">Consent</h2>
          <p>
          ...
          <h2 className="text-base font-bold text-slate-900 dark:text-white mt-6">Changes to this Privacy Policy</h2>
          <p>
